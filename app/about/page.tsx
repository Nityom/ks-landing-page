    ...
    <div className="min-h-screen bg-[#5FBBB5] text-[#16423B]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-6xl md:text-8xl font-light tracking-tight mb-8 text-white uppercase leading-none">
                ABOUT<br />
                <span className="text-4xl md:text-6xl text-white">— US</span>
              </h1>
            </div>
            <div className="md:text-right">
              <p className="text-sm md:text-base mb-4 font-light text-gray-200 max-w-md md:ml-auto leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-left mb-16 text-[#16423B] space-y-4 max-w-5xl mx-auto leading-relaxed tracking-wider text-base md:text-lg">
            <p>
      ...
      <section className="px-4 py-8 md:px-8 md:py-12 lg:py-16">
        <div className="mx-auto max-w-7xl">
          <section className="grid items-stretch gap-8 lg:grid-cols-2">
            <div className="relative rounded-3xl bg-[#E6F7F6] p-6 md:p-10 lg:p-12 border border-[#56AFA9] flex flex-col justify-between shadow-xl">
              <div>
                <h2 className="text-3xl font-light leading-[1.15] tracking-[-0.02em] sm:text-4xl md:text-5xl lg:text-6xl text-[#16423B]">
                ...
                <p className="mt-6 max-w-2xl text-base font-semibold text-[#16423B] md:text-lg">
                  Why Choose Us:
                </p>
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-3 rounded-2xl border border-[#56AFA9] bg-[#CBEBE8] px-4 py-3 shadow-sm md:px-5 md:py-4"
                    >
                      <span className="inline-flex items-center justify-center rounded-full bg-[#55A9A3] p-1.5 md:p-2 text-white">
              ...
              <p className="mt-8 max-w-2xl text-base leading-7 text-[#30807B] md:text-lg md:leading-8 font-light italic">
                We are committed to supporting your brand with packaging solutions that are innovative, sustainable, and dependable.
              </p>
            </div>
            <div className="relative overflow-hidden rounded-3xl border border-[#56AFA9] shadow-xl bg-[#CBEBE8] min-h-[450px]">
              <Image
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="font-light mb-8 leading-relaxed text-[#17252a] text-lg">
              ...
              <p className="font-light text-[#16423B] leading-relaxed text-base md:text-lg">
