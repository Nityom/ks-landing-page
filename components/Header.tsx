  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-50 md:hidden transform transition-all duration-500 ease-in-out overflow-hidden ${isMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
        <div className="absolute inset-0 bg-gradient-to-b from-[#2F5D50] to-[#2F5D50] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col">
          <div className="flex items-center justify-between p-6 border-b border-[#2F5D50]/50">
            ...
            <button
              ...
              className="p-2 text-[#31473A] hover:text-[#2F5D50] transition-colors rounded-full hover:bg-[#2F5D50]/20"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
