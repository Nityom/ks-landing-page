        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8">
             <nav className="space-y-2">
               <Link onClick={() => setIsMenuOpen(false)} href="/about" className="block text-[#16423B] text-lg font-medium py-4 px-4 rounded-lg hover:bg-[#77D1CB]/20 hover:text-[#77D1CB] transition-all duration-300 transform hover:translate-x-2">About</Link>
               <div className="bg-[#16423B]/10 rounded-lg overflow-hidden">
                  <div className="text-[#16423B] text-lg font-medium py-4 px-4 border-b border-[#56AFA9]/30">Our Products</div>
                  <div className="px-4">
                     <button className="flex items-center justify-between w-full text-left text-[#16423B] font-medium py-3 hover:text-[#77D1CB] transition-colors">
               ...
               <Link onClick={() => setIsMenuOpen(false)} href="/compostable" className="block text-[#16423B] text-lg font-medium py-4 px-4 rounded-lg hover:bg-[#77D1CB]/20 hover:text-[#77D1CB] transition-all duration-300 transform hover:translate-x-2">Compostable Paper Cups</Link>
               <Link onClick={() => setIsMenuOpen(false)} href="/contact" className="block text-[#16423B] text-lg font-medium py-4 px-4 rounded-lg hover:bg-[#77D1CB]/20 hover:text-[#77D1CB] transition-all duration-300 transform hover:translate-x-2">Contact</Link>
             </nav>
          </div>
        </div>
      </div>
